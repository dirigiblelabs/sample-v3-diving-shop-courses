...
var dao = require('diving-shop-courses/data/dao/Courses/ClassStudents');
var http = require('diving-shop-courses/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('ClassStudents not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop-courses/api/ClassStudents.js/' + entity.Id);
