...
var dao = require('diving-shop-courses/data/dao/Courses/Classes');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Classes not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop-courses/api/Classes.js/' + entity.Id);
