...
var dao = require('diving-shop-courses/data/dao/Courses/Students');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Students not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop-courses/api/Students.js/' + entity.Id);
