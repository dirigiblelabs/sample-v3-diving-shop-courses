...
var dao = require('diving-shop-courses/data/dao/Catalog/Courses');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Courses not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/diving-shop-courses/api/Courses.js/' + entity.Id);
