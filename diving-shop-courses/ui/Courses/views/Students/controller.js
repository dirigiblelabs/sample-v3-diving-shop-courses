...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'diving-shop.Courses.Students.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('diving-shop.Courses.Students.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/diving-shop-courses/api/Courses/Students.js';
